  ...
  <table class="table">
    ...
    <tbody>
      <?php
        ...
        $runModelScript = '/var/www/html/PCOS_AI/run_model.py';

        // Path to the CSV file (you can provide a default file or an empty file)
        $csvFile = '/var/www/html/PCOS_AI/empty.csv';
        ...
        $recommendations = ($output !== null) ? json_decode($output, true) : null;

        // Check if any recommendations are found
        if ($recommendations !== null && !empty($recommendations)) {
