...
--
-- Tabellenstruktur für Tabelle `HairTracking`
--

CREATE TABLE `HairTracking` (
  `hairId` int NOT NULL,
  `value` int NOT NULL,
  `date` date NOT NULL,
  `profileId` int NOT NULL
...
CREATE TABLE `Profile` (
  ...
  `weight` int NOT NULL,
  `name` text NOT NULL,
  `birthcontrol` text NOT NULL,
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

INSERT INTO `Profile` (`profileId`, `dob`, `ethnicity`, 'height', 'name', 'birthcontrol', 'weight') VALUES
(1, '01/01/2001', 'Asian', 176, 'Asian', 'Admin', 'hormonal', 55);
...
--
-- Tabellenstruktur für Tabelle `SelectedSymptoms`
--

CREATE TABLE `SelectedSymptoms` (
  `selectedSymptonId` int NOT NULL,
  `profileId` int NOT NULL,
...
--
-- Indizes für die Tabelle `HairTracking`
--
ALTER TABLE `HairTracking`
...
--
-- Indizes für die Tabelle `SelectedSymptoms`
--
ALTER TABLE `SelectedSymptoms`
  ADD PRIMARY KEY (`selectedSymptonId`),
...
--
-- AUTO_INCREMENT für Tabelle `HairTracking`
--
ALTER TABLE `HairTracking`
  MODIFY `hairId` int NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT für Tabelle `SelectedSymptoms`
--
ALTER TABLE `SelectedSymptoms`
  MODIFY `selectedSymptonId` int NOT NULL AUTO_INCREMENT;
...
--
-- Constraints der Tabelle `HairTracking`
--
ALTER TABLE `HairTracking`
  ADD CONSTRAINT `HairTracking_ibfk_1` FOREIGN KEY (`profileId`) REFERENCES `Profile` (`profileId`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
--
-- Constraints der Tabelle `SelectedSymptoms`
--
ALTER TABLE `SelectedSymptoms`
  ADD CONSTRAINT `SelectedSymptoms_ibfk_2` FOREIGN KEY (`symptomId`) REFERENCES `Symptoms` (`symptomId`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `SelectedSymptoms_ibfk_3` FOREIGN KEY (`profileId`) REFERENCES `Profile` (`profileId`) ON DELETE RESTRICT ON UPDATE RESTRICT;
